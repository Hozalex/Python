...
with open("example2.txt", "r", encoding="utf8") as file2:
...
average_salary = 0
count_lines = 0
with open("example3.txt", "r", encoding="utf8") as file3:
...
with open("example4.txt", "r", encoding="utf8") as file4:
    for string4 in file4.readlines():
        s4 = string4.split()
        s4[0] = ru_set[str_count]
        str_count += 1
        with open("new_example4.txt", "a", encoding="utf8") as n_file:
            n_file.writelines("%s\n" % ' '.join(s4))
print("___________________ \n  #5")
...
file5 = open("example5.txt", "w")
file5.write(' '.join(number_list))
file5.close()
with open("example5.txt", "r") as file5:
...
lesson_dict = {}
lesson_hour = 0
with open("example6.txt", "r", encoding="utf8") as file6:
